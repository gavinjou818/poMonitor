...
public class CommandLineAPI 
{
	...
	public void analyze() throws IOException {
		...
		URL url = new URL("http://ltpapi.voicecloud.cn/analysis/?" + "api_key="
				+ apikey + "&" + "text=" + text + "&" + "format=" + format
				+ "&" + "pattern=" + pattern);
	...
	private void usage() {
		...
		System.out.println("");
		System.out
				.println("      --apikey  APIKEY      use to specify the api key");
		System.out
				.println("      --text    TEXT        use to specify the text");
		System.out
				.println("      --pattern PATTERN     use to specify the pattern [ws/pos/dp/ner/srl]");
		System.out
