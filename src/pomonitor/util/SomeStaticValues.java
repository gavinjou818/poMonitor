...
public class SomeStaticValues 
{
	...
	public final static String seedUrl = "http://api.ltp-cloud.com/analysis/?";

	public final static String params = "api_key=15k332P7iaVazlMV1ZFXUyqyoMmP7PVcgQICeDTc&pattern=all&format=json&text=";
