...
//地域分布图
function ChinaPictureChart(loadurl, elementId, starttime, endtime, userId,
		method) {
	var Chart;
	$.ajax({
		type : "GET",
...
//今日舆情图
function PublicOpinionTodayChart(loadurl, elementId, startTime, endTime,
		userId, method) {
...
function WeeklyChart(loadurl, elementId, starttime, endtime, userId, method) {
	...
	startTime = reduceTime(endtime, 6);

	

	var arrobj = new Array();
	for (var i = 0; i <= 6; i++) {
		arrobj[i] = reduceTime(startTime, -i);
	}
...
//整体走势图
function OverallTrendChart(loadurl, elementId, starttime, endtime, userId,
		method) {
	var Chart;
	$.ajax({
		type : "GET",
...
//信息敏感分类图
function InformationSensitiveClassificationChart(loadurl, elementId, starttime,
		endtime, userId, method) {
...
//媒体负面趋势图
function MediaNegativeTendencyChart(loadurl, elementId, starttime, endtime,
		userId, method) {
...
//媒体来源
function MediaSourcesChart(loadurl, elementId, starttime, endtime, userId,
		method) {
	var Chart;
	$.ajax({
...
//信息来源类型图
function InformationSourcesChart(loadurl, elementId, starttime, endtime,
		userId, method) {
	var Chart;
	$.ajax({
		type : "GET",
...
function PropagationPathChart(loadurl, elementId, starttime, endtime, userId,
		method) {
	$.ajax({
		type : "GET",
		//url:"json/MTactive.json",
		...
		success : function(datt) {
			...
			var svg = d3.select("#" + elementId).select("svg").attr("width",
...
function HotPublicOpinion(loadurl, elementId, starttime, endtime, userId,
		method) {
	var Chart;
	$.ajax({
		...
		success : function(datt) {
			...
			var option = {
				...
				color : [ 'rgb(194,53,49)', 'rgb(178,144,137)',
						'rgb(97,160,168)' ],
				//图例，每个图表最多仅有一个图例
				legend : [ {
					x : 'left',//图例位置
